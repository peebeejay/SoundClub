...
# adele = User.find_by(username: "Adele")
# the_xx = User.find_by(username: "the_xx")
...
adele = User.create!(username: "Adele", password: "adelee", display_name: "Adele", location: "London", img: open("https://pbs.twimg.com/profile_images/657199367556866048/EBEIl2ol.jpg"))
the_xx = User.create!(username: "TheXX", password: "thexxx", display_name: "The xx", location: "Wandsworth, London", img: open("http://cps-static.rovicorp.com/3/JPG_400/MI0003/748/MI0003748160.jpg?partner=allrovi.com"))
...
#
# # Rachmaninoff
# Song.create!(title: "Piano Concerto No. 2 (Op. 18) - Adagio Sostenuto", user_id: rachmaninoff.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/009.+Sergej+Vassiljevitsj+Rachmaninoff+-+Piano+Concerto+No.+2+(Op.+18)+-+Adagio+Sostenuto.mp3"), img: open("http://e.snmc.io/lk/f/l/dabac015f5646c4bdbcbc7c18b6dbee1/1789629.jpg"))
# Song.create!(title: "Piano Concerto No. 2 (Op. 18) - Moderato", user_id: rachmaninoff.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/055.+Sergej+Vassiljevitsj+Rachmaninoff+-+Piano+Concerto+No.+2+(Op.+18)+-+Moderato.mp3"), img: open("http://e.snmc.io/lk/f/l/dabac015f5646c4bdbcbc7c18b6dbee1/1789629.jpg"))
...
# Adele
Song.create!(title: "Hello", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/01.+Hello.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "Send My Love", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/02.+Send+My+Love+(To+Your+New+Lover).mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "I Miss You", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/03.+I+Miss+You.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "When We Were Young", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/04.+When+We+Were+Young.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "Remedy", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/05.+Remedy.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "Water Under The Bridge", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/06.+Water+Under+The+Bridge.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "River Lea", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/07.+River+Lea.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "Love In The Dark", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/08.+Love+In+The+Dark.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "Million Years Ago", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/09.+Million+Years+Ago.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "All I Ask", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/10.+All+I+Ask.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "Sweetest Devotion", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/11.+Sweetest+Devotion.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "Can't Let Go", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/12.+Can%E2%80%99t+Let+Go+(Target+Exclusive).mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "Lay Me Down", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/13.+Lay+Me+Down+(Target+Exclusive).mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
Song.create!(title: "Why Do You Love Me", user_id: adele.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/14.+Why+Do+You+Love+Me+(Target+Exclusive).mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/Adele/Cover.jpg"))
p "Complete Adele"

# The xx
Song.create!(title: "Dangerous", user_id: the_xx.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/01+The+xx+-+Dangerous.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/photo.jpg"))
Song.create!(title: "Lips", user_id: the_xx.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/03+The+xx+-+Lips.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/photo.jpg"))
Song.create!(title: "A Violent Noise", user_id: the_xx.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/04+The+xx+-+A+Violent+Noise.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/photo.jpg"))
Song.create!(title: "Brave For You", user_id: the_xx.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/07+The+xx+-+Brave+For+You.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/photo.jpg"))
Song.create!(title: "On Hold", user_id: the_xx.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/08+The+xx+-+On+Hold.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/photo.jpg"))
Song.create!(title: "I Dare You", user_id: the_xx.id, audio: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/09+The+xx+-+I+Dare+You.mp3"), img: open("https://s3.amazonaws.com/soundclub-seeds/second_phase/the_xx/photo.jpg"))
p "Copmlete The xx"
